        ...
        <LightLayout footerClass={"mt-30"}>
            ...
            <section className="blog section-padding">
                <div className="container">
                    ...
                    <div className="row">
                        <ImgCard imgSrc={"/assets/img/services/pricing/51.jpeg"}>
                        ...
                        <ImgCard imgSrc={"/assets/img/services/pricing/52.jpeg"}>
                        ...
                        <ImgCard imgSrc={"/assets/img/services/pricing/53.jpg"}><p>Le budget de la rénovation complète d’un appartement ou d’une maison va surtout dépendre de la nature des travaux et de l’état du bien.
